...
//    let arVideoSource: ARVideoSource = ARVideoSource() // for passing the AR camera as the stream
    ...
    override func viewDidLoad() {
        ...
        // Changes has made here as the Int value to Bboolean values with sampleRate and channels variables.
        agSettings.externalAudioSettings = AgoraSettings.ExternalAudioSettings(
            enabled: true, sampleRate: 1, channels: 1
        )
